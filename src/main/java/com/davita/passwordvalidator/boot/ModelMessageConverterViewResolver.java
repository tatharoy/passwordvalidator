...
/**
 * A {@link ViewResolver} that returns a view that renders using a {@link MappingJackson2HttpMessageConverter}. The idea
 * being that this message converter is used to read in message bodies and convert them to models.
 */

public class ModelMessageConverterViewResolver implements ViewResolver {
     ...
     * Constructor.
     * 
     * @param converter the message converter used to generate the outbound responses
     */
    public ModelMessageConverterViewResolver(MappingJackson2HttpMessageConverter converter) {
    ...
    /**
     * A view that supports a model populated and whose body is written out using a
